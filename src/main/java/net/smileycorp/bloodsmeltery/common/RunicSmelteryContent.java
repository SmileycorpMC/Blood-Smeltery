...
public class RunicSmelteryContent {
    ...
    private static final BlockBehaviour.Properties PROPS = BlockBehaviour.Properties.of(Material.STONE)
    ...
    private static BlockTooltipItem tooltip(Block block) {
        return new BlockTooltipItem(block, new Item.Properties().tab(TinkerSmeltery.TAB_SMELTERY));
    }
